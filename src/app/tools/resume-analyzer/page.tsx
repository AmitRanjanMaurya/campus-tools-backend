      ...
      const mockAnalysis: ResumeAnalysis = {
        ...
        sections: {
          summary: { 
            ...
            feedback: ['Strong professional summary', 'Clear career objectives', 'Consider adding more keywords'] 
          },
          experience: { 
            score: Math.floor(Math.random() * 3) + 7, 
            feedback: ['Well-structured work history', 'Good use of action verbs', 'Quantify achievements more'] 
          },
          skills: { 
            score: Math.floor(Math.random() * 3) + 6, 
            feedback: ['Relevant technical skills listed', 'Consider grouping skills by category'] 
          },
          education: { 
            score: Math.floor(Math.random() * 2) + 8, 
            feedback: ['Education clearly presented', 'Include relevant coursework if applicable'] 
          },
          formatting: { 
            score: Math.floor(Math.random() * 3) + 7, 
            feedback: ['Clean, professional layout', 'Consistent formatting throughout', 'Good use of white space'] 
          }
        },
        generalSuggestions: [
        ...
        keywordMatches: ['JavaScript', 'React', 'Node.js', 'Python', 'Project Management'],
        missingKeywords: ['TypeScript', 'AWS', 'Docker', 'Agile', 'Leadership'],
        strengths: [
        ...
        improvements: [
          ...
          'Consider restructuring skills section',
          'Add volunteer work or side projects if applicable'
        ],
        atsIssues: [
                        ...
                        <div key={section} className="bg-white p-6 rounded-lg shadow-md border">
                          ...
                          <div className="flex items-center gap-3 mb-4">
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                              data.score >= 8 ? 'bg-green-100 text-green-600' :
                              data.score >= 6 ? 'bg-yellow-100 text-yellow-600' :
