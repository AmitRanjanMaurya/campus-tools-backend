            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <button
                  ...
                  className="p-6 bg-white border-2 border-secondary-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 text-left group"
                >
                  <div className="flex items-center mb-3">
                    <span className="w-4 h-4 rounded-full bg-gray-500 mr-3"></span>
                    <h4 className="font-semibold text-secondary-900 group-hover:text-primary-600">All Fields</h4>
                  </div>
                  <p className="text-sm text-secondary-600 mb-2">View all available categories</p>
                ...
                {Object.entries(academicCategories).map(([fieldKey, field]) => (
                  ...
                  >
                    <div className="flex items-center mb-3">
                      ...
                      <h4 className="font-semibold text-secondary-900 group-hover:text-primary-600">{field.name}</h4>
                    </div>
                    <p className="text-sm text-secondary-600 mb-2">{field.description}</p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center mb-3">
                        ...
                        <h4 className="font-semibold text-secondary-900 group-hover:text-primary-600">{category.name}</h4>
                      </div>
                      <p className="text-sm text-secondary-600 mb-2">{category.description}</p>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-secondary-600">{unitCategories[selectedCategory as keyof typeof unitCategories]?.description}</p>
                </div>
                <div></div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-secondary-700 mb-2">Enter Value</label>
                    <input
                      type="number"
                      value={inputValue}
                      onChange={(e) => {
                      ...
                      className="w-full px-4 py-3 border-2 border-secondary-200 rounded-lg focus:border-primary-500 focus:outline-none text-lg"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-secondary-700 mb-2">Result</label>
                    <div className="w-full px-4 py-3 bg-primary-50 border-2 border-primary-200 rounded-lg text-lg font-semibold text-primary-800">
                      {result || '0'}
                    </div>
                  </div>
                </div>
                ...
                {unitCategories[selectedCategory as keyof typeof unitCategories]?.formula && (
                  <div className="bg-secondary-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-secondary-900 mb-2">Quick Reference</h4>
        ...
        <div className="card mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-secondary-900 mb-2">Choose Field</h4>
              <p className="text-sm text-secondary-600">Select an academic field or view all categories</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-primary-600 font-bold">2</span>
              </div>
              <h4 className="font-semibold text-secondary-900 mb-2">Pick Category</h4>
              <p className="text-sm text-secondary-600">Choose the type of measurement to convert</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-primary-600 font-bold">3</span>
              </div>
              <h4 className="font-semibold text-secondary-900 mb-2">Convert</h4>
              <p className="text-sm text-secondary-600">Enter your value and see instant results</p>
            </div>
          </div>
        </div>
      </div>
